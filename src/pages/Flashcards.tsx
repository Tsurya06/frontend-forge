        ...
        <Card>
          <div className={styles.config}>
            <div className={styles.configRow}>
              <label className={styles.configLabel} htmlFor="fc-category">Category</label>
              <select
                id="fc-category"
            ...
            <div className={styles.configRow}>
              <label className={styles.configLabel} htmlFor="fc-count">Number of Cards</label>
              <select
                id="fc-count"
                className={styles.select}
                value={cardCount}
          ...
          <div className={styles.resultsCard}>
            <div className={styles.resultsStats}>
              <div className={styles.resultStat}>
                <span className={styles.resultStatValue}>{progress.easy.length}</span>
                <span className={styles.resultStatLabel}>Easy</span>
              </div>
              <div className={styles.resultStat}>
                <span className={styles.resultStatValue}>{progress.hard.length}</span>
                <span className={styles.resultStatLabel}>Hard</span>
              </div>
              <div className={styles.resultStat}>
                <span className={styles.resultStatValue}>{progress.skipped.length}</span>
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.controls}>
        <button type="button" className={styles.controlBtn} onClick={previous} disabled={currentIndex === 0}>
          {"← Previous"}
        </button>
        <button type="button" className={styles.controlBtn} onClick={flip}>
          Flip
        </button>
        <button type="button" className={styles.controlBtn} onClick={next} disabled={currentIndex >= totalCards - 1}>
          {"Next →"}
        </button>
      </div>

      <div className={styles.ratingControls}>
        <button type="button" className={`${styles.ratingBtn} ${styles.easyBtn}`} onClick={markEasy}>
          Easy
        </button>
        <button type="button" className={`${styles.ratingBtn} ${styles.hardBtn}`} onClick={markHard}>
          Hard
        </button>
        <button type="button" className={`${styles.ratingBtn} ${styles.skipRatingBtn}`} onClick={skip}>
          Skip
        </button>
      </div>
    </div>
