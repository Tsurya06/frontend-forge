...
export default function Senior() {
  ...
  const totalDone = allSeniorQuestions.filter(q => completedQuestions.includes(q.id)).length;
      ...
      <div className={styles.stickyTopBar}>
        <header className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Architecture, scalability, performance, security, and technical leadership
          </p>
        </header>

        <div className={styles.statsBar}>
          <span className={styles.statItem}>{seniorTopics.length} topic areas</span>
          <span className={styles.statDivider}>•</span>
          <span className={styles.statItem}>{allSeniorQuestions.length} deep-dive questions</span>
          <span className={styles.statDivider}>•</span>
      ...
      <div className={styles.scrollableContent}>
        {filtered.length === 0 ? (
          <EmptyState
            ...
            description={search ? 'Try adjusting your search' : 'Senior questions haven\'t been added yet.'}
