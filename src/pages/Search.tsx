    ...
    <div className={styles.page}>
      <header className={styles.header}>
        ...
        <p className={styles.subtitle}>
          Search across 85 topics, 500+ interview questions, coding challenges,
          and machine coding problems.
        </p>
      </header>
          ...
          {sections.map((section) => (
            <section key={section.type} className={styles.resultSection}>
              <h2 className={styles.sectionTitle}>
                {getTypeLabel(section.type)} ({section.items.length})
              </h2>
                ...
                {section.items.map((item) => (
                  ...
                  >
                    <div className={styles.resultHeader}>
                      ...
                      <Badge
                        variant={
                          difficultyVariant[item.difficulty as Difficulty] ||
                          "tag"
                        }
                        size="small"
                      >
