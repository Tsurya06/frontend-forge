...
export const allMachineCodingProblems: MachineCodingProblem[] =
  machineCodingProblems;
export const allSystemDesignProblems: SystemDesignProblem[] =
...
export function getTopicsByCategory(category: string): Topic[] {
  ...
  return allTopics.filter(
    (t) => t.category === category || normalize(t.category) === norm,
  );
}
...
export function getTopicById(id: string): Topic | undefined {
  ...
  const normalized = allTopics.find((t) => {
    ...
    return (
      cleanT === cleanId ||
      cleanTitle === cleanId ||
      cleanT.includes(cleanId) ||
      cleanId.includes(cleanT)
    );
  });
...
export function getCodingProblemById(id: string): CodingProblem | undefined {
  ...
  return allCodingProblems.find((p) => {
    ...
    return (
      cleanP === cleanId || cleanP.includes(cleanId) || cleanId.includes(cleanP)
    );
  });
}

export function getMachineCodingProblemById(
  id: string,
): MachineCodingProblem | undefined {
  if (!id) return undefined;
  ...
  return allMachineCodingProblems.find((p) => {
    ...
    return (
      cleanP === cleanId ||
      cleanTitle === cleanId ||
      cleanP.includes(cleanId) ||
      cleanId.includes(cleanP)
    );
  });
}

export function getSystemDesignProblemById(
  id: string,
...
export const categories: Category[] = [
  {
    id: "javascript",
    title: "JavaScript",
    description: "Core and advanced JavaScript concepts",
    icon: "\u26A1",
    color: "#f7df1e",
    route: "/javascript",
    topicCount: 0,
  ...
  },
  {
    id: "html",
    title: "HTML",
    description: "HTML5, semantic elements, forms, accessibility",
    icon: "\uD83C\uDF10",
    color: "#e34c26",
    route: "/html",
    topicCount: 0,
  ...
  },
  {
    id: "css",
    title: "CSS",
    description: "Styling, layout, animations, preprocessors",
    icon: "\uD83C\uDFA8",
    color: "#264de4",
    route: "/css",
    topicCount: 0,
  ...
  },
  {
    id: "browser",
    title: "Browser & Web",
    description: "Browser internals, HTTP, performance, DevTools",
    icon: "\uD83D\uDD0D",
    color: "#4285f4",
    route: "/browser",
    topicCount: 0,
  ...
  },
  {
    id: "react",
    title: "React",
    description: "Components, hooks, state, rendering, SSR",
    icon: "\u269B\uFE0F",
    color: "#61dafb",
    route: "/react",
    topicCount: 0,
  ...
  },
  {
    id: "typescript",
    title: "TypeScript",
    description: "Types, generics, utility types, React + TS",
    icon: "\uD83D\uDCD8",
    color: "#3178c6",
    route: "/typescript",
    topicCount: 0,
  ...
  },
  {
    id: "performance",
    title: "Performance",
    description: "Optimization, caching, lazy loading, Web Vitals",
    icon: "\uD83D\uDE80",
    color: "#ff6b35",
    route: "/performance",
    topicCount: 0,
  ...
  },
  {
    id: "security",
    title: "Security",
    description: "XSS, CSRF, CSP, secure coding",
    icon: "\uD83D\uDD12",
    color: "#dc2626",
    route: "/security",
    topicCount: 0,
  ...
  },
  {
    ...
    description: "Singleton, Factory, Observer, HOC",
    icon: "\uD83C\uDFD7\uFE0F",
    color: "#8b5cf6",
  ...
  },
  {
    id: "build-tools",
    title: "Build Tools",
    description: "Webpack, Babel, ESLint",
    icon: "\uD83D\uDD27",
    color: "#8dd6f9",
    route: "/build-tools",
    topicCount: 0,
  ...
  },
  {
    id: "code-quality",
    title: "Code Quality",
    description: "SOLID, DRY, KISS, clean code",
    icon: "\u2728",
    color: "#22c55e",
    route: "/code-quality",
    topicCount: 0,
  ...
  },
  {
    id: "accessibility",
    title: "Accessibility",
    description: "ARIA, keyboard nav, WCAG",
    icon: "\u267F",
    color: "#0ea5e9",
    route: "/accessibility",
    topicCount: 0,
  ...
  },
  {
    ...
    description: "Architecture, scalability, system design thinking",
    icon: "\uD83C\uDF1F",
    color: "#f59e0b",
    route: "/senior",
    topicCount: 0,
