    ...
    questions: [
      {
        ...
        tags: ['pure functions', 'side effects', 'referential transparency', 'memoization'],
        commonMistakes: [
      ...
      {
        id: 'js-fp-2',
        question: 'What is immutability and how do you achieve it in JavaScript?',
        answer:
        ...
        category: 'JavaScript',
        topicId: 'js-functional',
        tags: ['immutability', 'spread operator', 'Object.freeze', 'Immer', 'state management'],
        commonMistakes: [
      ...
      },
      {
        ...
        category: 'JavaScript',
        topicId: 'js-functional',
        tags: ['map', 'filter', 'reduce', 'array methods', 'data transformation'],
        commonMistakes: [
      ...
      },
      {
        ...
        category: 'JavaScript',
        topicId: 'js-functional',
        tags: ['currying', 'partial application', 'closures', 'function composition'],
        commonMistakes: [
      ...
      {
        id: 'js-fp-5',
        question: 'What is partial application? How is it different from currying?',
        answer:
        ...
        category: 'JavaScript',
        topicId: 'js-functional',
        tags: ['partial application', 'currying', 'bind', 'closures', 'function factories'],
        commonMistakes: [
      ...
      },
      {
        ...
        category: 'JavaScript',
        topicId: 'js-functional',
        tags: ['composition', 'pipe', 'compose', 'data pipelines', 'point-free'],
        commonMistakes: [
      ...
      },
      {
        ...
        category: 'JavaScript',
        topicId: 'js-functional',
        tags: ['higher-order functions', 'closures', 'decorators', 'function factories', 'HOC'],
        commonMistakes: [
      ...
      {
        id: 'js-fp-8',
        question: 'What are side effects and how do they relate to functional programming?',
        answer:
        ...
        category: 'JavaScript',
        topicId: 'js-functional',
        tags: ['side effects', 'purity', 'functional core', 'imperative shell', 'useEffect'],
        commonMistakes: [
