...
export const asyncTopics: Topic[] = [
  {
    ...
    questions: [
      ...
      {
        id: "js-async-9",
        question: "Predict the output: setTimeout vs Promise vs console.log",
        answer:
      ...
      {
        id: "js-async-10",
        question: "Predict the output: nested setTimeout and Promise",
        answer:
      ...
      },
      {
        id: "js-async-14",
        question:
          "What are Web APIs and how do they interact with the event loop?",
        answer:
