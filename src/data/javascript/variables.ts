...
export const variablesTopics: Topic[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        category: "JavaScript",
        topicId: "js-variables",
        tags: ["global scope", "function scope", "block scope", "module scope"],
        commonMistakes: [
        ...
        relatedTopics: ["var", "let", "const", "modules", "lexical scope"],
      },
      {
        id: "js-vars-8",
        question:
      ...
      },
      {
        ...
        relatedTopics: ["hoisting", "temporal dead zone", "execution context"],
      },
    ],
  },
];
