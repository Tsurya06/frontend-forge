...
export const oopTopics: Topic[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        relatedTopics: ['Prototypal Inheritance', 'Property Lookup', 'hasOwnProperty'],
      },
      {
        id: 'js-oop-3',
      ...
      },
      {
        ...
        relatedTopics: ['this Keyword', 'Partial Application', 'Method Borrowing'],
      },
      {
        id: 'js-oop-7',
      ...
      },
      {
        ...
        relatedTopics: ['Private Fields', 'Closures', 'WeakMap', 'Module Pattern'],
      },
      {
        id: 'js-oop-9',
        ...
        relatedTopics: ['Inheritance', 'Duck Typing', 'Iterators', 'Interfaces'],
      },
      {
        id: 'js-oop-10',
        question:
        ...
        relatedTopics: ['Prototype Chain', 'Constructor Functions', 'Object.create'],
      },
    ],
  },
];
