...
export const advancedTopics: Topic[] = [
  {
    ...
    title:
      "Rendering Strategies (SSR, CSR, SSG, ISR), Hydration, RSC & Suspense",
    description:
    ...
    questions: [
      {
        id: "react-adv-1",
        question:
          "Compare CSR, SSR, SSG, and ISR rendering strategies. When would you choose each for an enterprise frontend architecture?",
        answer:
...
export async function getServerSideProps(context: any) {
  ...
  return { props: { data } };
        ...
        followUps: [
          "How does Edge SSR (Cloudflare Workers / Vercel Edge) reduce TTFB compared to traditional Node.js SSR?",
        ],
        interviewTips: [
          "Draw a comparative quadrant showing Build Time vs Request Time and Dynamic vs Static content.",
        ],
      },
      {
        id: "react-adv-2",
        question:
          "What is Hydration in React, what causes Hydration Mismatch errors, and how does React 18/19 Selective Hydration work?",
        answer:
  ...
  return (
    <article>
      ...
      <Suspense fallback={<div>Loading comments...</div>}>
        ...
        followUps: [
          "How does suppressHydrationWarning work and when is it acceptable to use?",
        ],
        interviewTips: [
          "Highlight that Selective Hydration prioritizes user interaction (clicking an unhydrated button triggers immediate prioritized hydration).",
        ],
      },
      {
        id: "react-adv-3",
        question:
          'Explain React Server Components (RSC). How do Server Components differ from Client Components, and what is the "use client" directive?',
        answer:
  ...
  return (
    ...
    >
      {loading ? 'Adding...' : 'Add to Cart'}
        ...
        followUps: [
          'How do Server Actions ("use server") allow client components to invoke server functions with type safety?',
        ],
        interviewTips: [
          'Clarify that "use client" is a boundary marker defining the entry point to the client JavaScript bundle, not a client-only rendering directive.',
        ],
      },
    ],
  },
