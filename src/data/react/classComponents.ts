...
export const classComponentTopics: Topic[] = [
  {
    ...
    tags: ['react', 'class-components', 'lifecycle', 'error-boundaries', 'componentDidMount', 'componentDidCatch'],
    overview:
    ...
    questions: [
      {
        id: 'react-class-1',
        question: 'Explain the complete React component lifecycle for class components across Mounting, Updating, and Unmounting phases.',
        answer:
...
export class UserProfile extends Component<Props, State> {
  ...
  render() {
    ...
    return <div>Hello, {user?.name}</div>;
        ...
        tags: ['class-components', 'lifecycle', 'componentDidMount', 'componentDidUpdate', 'componentWillUnmount'],
        commonMistakes: [
        ...
        followUps: ['How do getDerivedStateFromProps and getSnapshotBeforeUpdate differ from useEffect?'],
        interviewTips: ['Trace the execution order of parent vs child componentDidMount (child mounts before parent).']
      },
      {
        id: 'react-class-2',
        question: 'What are Error Boundaries in React, how are they implemented, and what errors can they NOT catch?',
        answer:
...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    return this.props.children;
        ...
        category: 'React',
        topicId: 'react-class-components',
        tags: ['error-boundary', 'componentDidCatch', 'getDerivedStateFromError', 'resilience'],
        commonMistakes: [
        ...
        followUps: ['How does react-error-boundary library allow resetting error state?'],
        interviewTips: ['Mention the 4 exclusions (event handlers, async, SSR, self-errors) — this is a classic interview gotcha.']
      }
    ]
  }
];
