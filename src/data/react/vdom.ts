    ...
    questions: [
      {
        id: "react-vdom-1",
        question:
          "How does React's Reconciliation diffing algorithm work, and what are its two core heuristics?",
        answer:
...
{items.map((item) => (
  <TodoItem key={item.id} text={item.text} />
        ...
        followUps: [
          "Why does an index as key cause input fields or state to retain old values when an item is deleted?",
        ],
        interviewTips: [
          "Mention the $O(N^3)$ theoretical tree diff vs React's $O(N)$ heuristic constraint.",
        ],
      },
      {
        id: "react-vdom-2",
        question:
          "What is the React Fiber architecture and how does it enable Concurrent React features (like useTransition)?",
        answer:
  ...
  return (
    <div>
      ...
      <ul>
        ...
        followUps: [
          "How does React 17+ SyntheticEvent delegation at the root container differ from React 16 delegation at document level?",
        ],
        interviewTips: [
          "Explaining the child-sibling-return linked list data structure shows extraordinary depth.",
        ],
      },
      {
        id: "react-vdom-3",
        question:
          "How do React Synthetic Events work, and what changed in event delegation in React 17?",
        answer:
...
function handleClick(e: React.MouseEvent<HTMLButtonElement>) {
  ...
  e.stopPropagation(); // Stops propagation in React tree AND at root container level
        ...
        followUps: [
          "How do Synthetic Events interact with third-party vanilla JS event listeners?",
        ],
        interviewTips: [
          "Mention the React 17 change from document delegation to root container delegation for micro-frontends.",
        ],
      },
    ],
  },
