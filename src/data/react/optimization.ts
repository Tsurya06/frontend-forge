    ...
    questions: [
      {
        id: "react-perf-1",
        question:
          "When does a React component re-render, and how do React.memo, useMemo, and useCallback work together to prevent wasted re-renders?",
        answer:
  ...
  return (
    <div>
      ...
      <ul>
        ...
        followUps: [
          "How does React Compiler (React Forget) automate memoization at build time?",
        ],
        interviewTips: [
          "Emphasize that `React.memo` requires stable prop references (via useCallback/useMemo) to function effectively.",
        ],
      },
      {
        id: "react-perf-2",
        question:
          "What is DOM Virtualization (Windowing) and how does it allow rendering lists with 100,000+ items smoothly at 60 FPS?",
        answer:
  ...
  return (
    ...
    >
      ...
      >
        ...
        followUps: [
          "How do you handle variable-height items in virtualized lists using ResizeObserver?",
        ],
        interviewTips: [
          "Explain the math: Total height spacer + translateY offset for visible slice.",
        ],
      },
    ],
  },
