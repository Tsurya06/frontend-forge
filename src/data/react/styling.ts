    ...
    questions: [
      {
        id: "react-styling-1",
        question:
          "Compare CSS Modules, Tailwind CSS, and Styled Components. What are their architectural tradeoffs?",
        answer:
...
\`;`,
        ...
        followUps: [
          "Why does React team recommend Zero-Runtime CSS (like Vanilla Extract or StyleX) for modern React apps?",
        ],
        interviewTips: [
          "Highlight that runtime CSS-in-JS incurs a performance penalty on frequent re-renders due to style recalculation.",
        ],
      },
      {
        id: "react-styling-2",
        question:
          "Why do runtime CSS-in-JS libraries struggle with React Server Components (RSC) and Streaming SSR?",
        answer:
...
export function Button() {
  return <button className={styles.button}>Server Component Ready</button>;
        ...
        followUps: [
          "How does Next.js App Router handle static vs dynamic CSS chunking?",
        ],
        interviewTips: [
          "Explaining the incompatibility between streaming HTTP responses and runtime <style> injection shows deep fullstack React knowledge.",
        ],
      },
    ],
  },
