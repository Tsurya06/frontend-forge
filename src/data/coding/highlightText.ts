  ...
  examples: [
    {
      ...
      explanation:
        'Both "The" and "the" are matched case-insensitively and wrapped in mark tags with original casing.',
    },
    {
    ...
    },
    {
      ...
      explanation:
        "Special regex characters ($ and .) in the search term are properly escaped.",
    },
  ],
...
function highlightTextParts(text: string, searchTerm: string): HighlightPart[] {
  ...
  timeComplexity:
    "O(n) where n is the length of the text string (single pass with regex).",
