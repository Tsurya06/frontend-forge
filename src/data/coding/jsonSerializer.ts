...
// '{"val":42}'`,
  ...
  timeComplexity:
    "O(n) where n is the total number of values in the structure (each value is visited exactly once).",
  spaceComplexity:
    "O(d) where d is the maximum nesting depth (recursion stack), plus O(n) for the output string.",
