  ...
  examples: [
    {
      ...
      explanation:
        "Pre-order DFS visits a, enters branch b, visits c, d, then visits e.",
    },
  ],
...
export function dfsObject(
  ...
  timeComplexity:
    "O(N) where N is the total number of keys and values in the object tree.",
  spaceComplexity:
    "O(D) call stack space where D is the maximum nesting depth of the tree.",
