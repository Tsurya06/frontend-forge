...
export const cssTopics: Topic[] = [
  // ─── 1. Class Selectors & Other Selectors ───────────────────────────
  {
    ...
    category: 'CSS',
    difficulty: 'Beginner',
    tags: ['selectors', 'combinators', 'attribute-selectors', 'pseudo-classes', 'pseudo-elements', 'has', 'is', 'where'],
    overview:
    ...
    questions: [
      {
        id: 'css-selectors-1',
        question: 'What are the CSS combinators and how do descendant, child, adjacent sibling, and general sibling combinators differ?',
        answer:
...
input ~ button { opacity: 1; }`,
        ...
        followUps: ['How does :has() simulate previous-sibling or parent selection?'],
        interviewTips: ['Show practical use cases, like using + for input label float patterns or typography vertical margins.']
      },
      {
        id: 'css-selectors-2',
        question: 'Explain modern CSS pseudo-classes: :is(), :where(), and the relational selector :has().',
        answer:
...
fieldset:has(input:invalid) { border-color: red; }`,
        ...
        followUps: ['What are the performance implications of complex :has() selectors?'],
        interviewTips: ['Highlight that :has() eliminated the need for JavaScript class toggles for parent/sibling state in modern web apps.']
      },
      {
        id: 'css-selectors-3',
        question: 'What is the difference between pseudo-classes (:hover, :focus, :nth-child) and pseudo-elements (::before, ::after)?',
        answer:
...
::selection {
  ...
  color: #1e293b;
        ...
        category: 'CSS',
        topicId: 'css-selectors',
        tags: ['pseudo-class', 'pseudo-element', 'before', 'after', 'nth-child'],
        commonMistakes: [
        ...
        followUps: ['How does :focus-visible differ from :focus for accessibility?'],
        interviewTips: ['Mention :focus-visible as an accessibility best practice to avoid showing focus rings on mouse clicks while keeping them for keyboard Tab navigation.']
      }
    ]
  },
  ...
  // ─── 2. Box Model, Normal Flow & Centering ───────────────────────────
  {
    ...
    category: 'CSS',
    difficulty: 'Beginner',
    tags: ['box-model', 'border-box', 'margin-collapsing', 'centering', 'normal-flow'],
    overview:
    ...
    questions: [
      {
        id: 'css-box-model-1',
        question: 'Explain the difference between box-sizing: content-box and box-sizing: border-box.',
        answer:
...
.box-border {
  ...
  /* Rendered width = 100px */
        ...
        interviewTips: ['Explain why border-box was inspired by the old IE quirk mode box model.']
      },
      {
        id: 'css-box-model-2',
        question: 'What is margin collapsing and under what conditions does it occur and how can it be prevented?',
        answer:
...
.parent-fix-3 {
  ...
  flex-direction: column;
        ...
        followUps: ['How do negative margins interact with positive margins during collapsing?'],
        interviewTips: ['Mention `display: flow-root` as the clean modern standard for creating a BFC without side effects like hiding overflowing menus.']
      },
      {
        id: 'css-box-model-3',
        question: 'Describe the modern ways to horizontally and vertically center an element in CSS.',
        answer:
...
.center-abs {
  ...
  transform: translate(-50%, -50%);
        ...
        followUps: ['Why does margin: auto work vertically inside Flexbox but not in normal block flow?'],
        interviewTips: ['Show `place-items: center` in CSS Grid as the modern 2-line standard.']
      }
    ]
  },
  ...
  // ─── 3. Flexbox & Grid Layouts ───────────────────────────────────────
  {
    ...
    category: 'CSS',
    difficulty: 'Intermediate',
    tags: ['flexbox', 'grid', 'css-grid', 'minmax', 'subgrid', 'auto-fit', 'auto-fill', 'fr'],
    overview:
    ...
    questions: [
      {
        ...
        question: 'Explain the flex shorthand property: flex: grow shrink basis. How do flex: 1, flex: auto, and flex: initial behave?',
        answer:
...
.badge   { flex-shrink: 0; }`,
        ...
        followUps: ['Why is min-width: 0 needed on flex children with text truncation?'],
        interviewTips: ['Mention the `min-width: 0` fix for flex truncation — interviewers love this bug/solution!']
      },
      {
        id: 'css-flexbox-grid-2',
        question: 'How do you create an intrinsically responsive grid without media queries using repeat(auto-fit, minmax(250px, 1fr))? What is the difference between auto-fit and auto-fill?',
        answer:
...
/* With 1 card: auto-fit expands card to 100% width.
   auto-fill keeps card at 280px and leaves empty space. */`,
        ...
        followUps: ['How does CSS Subgrid allow nested cards to align headers and footers across rows?'],
        interviewTips: ['Highlight that auto-fit + minmax replaces dozens of breakpoint media queries.']
      },
      {
...
.app-layout {
  ...
  height: 100vh;
        ...
        followUps: ['Can Flexbox and Grid be composed together? Give an example.'],
        interviewTips: ['Mention: "Flexbox from the content out, Grid from the layout in".']
      }
    ]
  },
  ...
  // ─── 4. Positioning, Stacking Context & z-index ──────────────────────
  {
    ...
    questions: [
      {
        id: 'css-pos-1',
        question: 'Explain how position: static, relative, absolute, fixed, and sticky differ in document flow and containing block.',
        answer:
...
.overlay {
  ...
  place-items: center;
        ...
        interviewTips: ['Mention `inset: 0` as the modern shorthand for `top: 0; right: 0; bottom: 0; left: 0`.']
      },
      {
        id: 'css-pos-2',
        question: 'What is a Stacking Context, how is it created, and why does setting z-index: 999999 sometimes fail to bring an element to the front?',
        answer:
...
.component-root {
  isolation: isolate; /* Creates isolated local stacking context */
        ...
        followUps: ['How does isolation: isolate solve component z-index leakage in design systems?'],
        interviewTips: ['Explaining the flattening of child stacking contexts immediately signals senior-level CSS mastery.']
      }
    ]
  },
  ...
  // ─── 5. Specificity, Cascade & Inheritance ───────────────────────────
  {
    ...
    category: 'CSS',
    difficulty: 'Intermediate',
    tags: ['specificity', 'cascade', 'inheritance', 'cascade-layers', 'important'],
    overview:
    ...
    questions: [
      {
        id: 'css-spec-1',
        question: 'How is CSS Specificity calculated? Rank the specificity of various selector combinations.',
        answer:
...
color: red !important; /* Overrides everything */`,
        ...
        interviewTips: ['Write out the (0, 1, 1) tuple notation clearly during interviews to show precise understanding.']
      },
      {
        id: 'css-spec-2',
        question: 'What are CSS Cascade Layers (@layer) and how do they solve specificity wars in large applications?',
        answer:
...
@layer components {
  ...
  .link { color: blue; }
        ...
        interviewTips: ['Mention that @layer is now supported across all modern evergreen browsers (Chrome, Safari, Firefox, Edge).']
      }
    ]
  },
  ...
  // ─── 6. CSS Variables, BEM & Preprocessors ───────────────────────────
  {
    ...
    category: 'CSS',
    difficulty: 'Intermediate',
    tags: ['css-variables', 'custom-properties', 'bem', 'scss', 'sass', 'mixins', 'theming'],
    overview:
    ...
    questions: [
      {
        id: 'css-var-1',
        question: 'How do CSS Custom Properties (CSS Variables) differ from SASS/SCSS variables, and how do you implement dynamic dark mode with them?',
        answer:
...
// document.documentElement.style.setProperty('--color-primary', '#10b981');`,
        ...
        tags: ['css-variables', 'custom-properties', 'dark-mode', 'theming', 'sass'],
        commonMistakes: [
        ...
        followUps: ['How does @property register custom properties with type checking and default animation values?'],
        interviewTips: ['Explain how CSS variables allow seamless dark mode toggle with zero layout recalculation.']
      },
      {
        id: 'css-var-2',
        question: 'Explain the BEM (Block, Element, Modifier) naming convention and its architectural benefits.',
        answer:
...
.card--dark { /* Modifier on Block */
  ...
  color: white;
        ...
        interviewTips: ['Emphasize that BEM keeps specificity at (0, 1, 0) across entire enterprise codebases.']
      }
    ]
  },
  ...
  // ─── 7. Media Queries, Container Queries & Responsive Design ─────────
  {
    ...
    category: 'CSS',
    difficulty: 'Intermediate',
    tags: ['media-queries', 'container-queries', 'responsive-design', 'prefers-reduced-motion', 'mobile-first'],
    overview:
    ...
    questions: [
      {
        id: 'css-resp-1',
        question: 'What are CSS Container Queries (@container) and how do they solve the limitations of Viewport Media Queries (@media)?',
        answer:
...
@container card-wrapper (min-width: 450px) {
  ...
  .card__image {
    width: 180px;
        ...
        followUps: ['What are container query units (cqw, cqi) and how can they be used for fluid typography?'],
        interviewTips: ['Container queries represent the biggest paradigm shift in responsive CSS since Flexbox and Grid.']
      },
      {
        id: 'css-resp-2',
        question: 'How do accessibility media queries like prefers-reduced-motion enhance user experience?',
        answer:
...
@media (prefers-reduced-motion: reduce) {
  .banner {
    transition: none; /* Disable animation */
        ...
        followUps: ['What other preference media queries exist (e.g. prefers-contrast, forced-colors)?'],
        interviewTips: ['Mentioning prefers-reduced-motion demonstrates deep accessibility and frontend empathy.']
      }
    ]
  },
  ...
  // ─── 8. Animations, Transitions & Performance ────────────────────────
  {
    ...
    category: 'CSS',
    difficulty: 'Intermediate',
    tags: ['animations', 'transitions', 'keyframes', 'gpu-acceleration', 'will-change', 'performance'],
    overview:
    ...
    questions: [
      {
        id: 'css-anim-1',
        question: 'Explain the browser rendering pipeline (Layout, Paint, Composite) and why animating transform and opacity is vastly more performant than animating top, left, or height.',
        answer:
...
.drawer-good.open {
  transform: translateX(0);
        ...
        tags: ['performance', 'gpu', 'transform', 'reflow', 'repaint', 'composite'],
        commonMistakes: [
        ...
        followUps: ['How can CSS Grid animate accordion expansion smoothly without JavaScript?'],
        interviewTips: ['Show how `grid-template-rows: 0fr` to `1fr` animates height without fixed pixel assumptions.']
      },
      {
        id: 'css-anim-2',
        question: 'What does animation-fill-mode: forwards and backwards do in CSS @keyframes animations?',
        answer:
...
.card {
  ...
  /* 0.2s delay applies 0% styles immediately, and stays at 100% when done */
        ...
        followUps: ['How does Web Animations API (WAAPI) in JavaScript compare to CSS Keyframes?'],
        interviewTips: ['Recommend using `animation-fill-mode: both` for delayed entrance animations to avoid visual flashes.']
      }
    ]
  }
];
