...
const handleClick: EventHandler = (e) => {
  console.log(e.clientX); // e inferred as MouseEvent
        ...
        category: 'TypeScript',
        topicId: 'ts-fundamentals-1',
        tags: ['type inference', 'contextual typing', 'literal types', 'as const'],
        commonMistakes: [
      ...
      },
      {
        ...
        question: 'Explain enums in TypeScript, including numeric, string, and const enums.',
        answer:
...
const isPositive: Predicate<number> = (n) => n > 0;`,
        ...
        category: 'TypeScript',
        topicId: 'ts-fundamentals-1',
        tags: ['functions', 'overloads', 'optional parameters', 'rest parameters', 'function types'],
        commonMistakes: [
      ...
      },
      {
        ...
        question: 'What are tuples in TypeScript and how do they differ from arrays?',
        answer:
...
if (isUser(data)) {
  console.log(data.name); // type-safe access
      ...
      },
      {
        ...
        question:
          'What are literal types in TypeScript and how are they used?',
        answer:
...
function area(shape: Shape): number {
  switch (shape.kind) {
    ...
    case "rectangle": return shape.width * shape.height;
        ...
        category: 'TypeScript',
        topicId: 'ts-fundamentals-1',
        tags: ['literal types', 'template literal types', 'as const', 'discriminated unions'],
        commonMistakes: [
...
console.log(config.toUpperCase()); // narrowed to string after assertion`,
        ...
        category: 'TypeScript',
        topicId: 'ts-fundamentals-1',
        tags: ['type assertions', 'as', 'non-null assertion', 'assertion functions', 'type guards'],
        commonMistakes: [
...
type Impossible = string & number; // never`,
        ...
        tags: ['union types', 'intersection types', 'discriminated unions', 'narrowing'],
        commonMistakes: [
...
type ApiResponse<T = unknown> = {
  ...
  message: string;
        ...
        category: 'TypeScript',
        topicId: 'ts-advanced-1',
        tags: ['generics', 'constraints', 'keyof', 'extends', 'type parameters'],
        commonMistakes: [
...
type MyPartial<T> = { [K in keyof T]?: T[K] };`,
        ...
        category: 'TypeScript',
        topicId: 'ts-advanced-1',
        tags: ['utility types', 'Partial', 'Pick', 'Omit', 'Record', 'ReturnType', 'Exclude'],
        commonMistakes: [
...
type I = TypeName<() => void>; // "function"`,
        ...
        category: 'TypeScript',
        topicId: 'ts-advanced-1',
        tags: ['conditional types', 'infer', 'distributive', 'extends', 'type-level programming'],
        commonMistakes: [
...
// { db?: { host?: string; port?: number }; cache?: { ttl?: number } }`,
        ...
        category: 'TypeScript',
        topicId: 'ts-advanced-1',
        tags: ['mapped types', 'key remapping', 'modifiers', 'readonly', 'template literal types'],
        commonMistakes: [
...
type StatusKey = keyof typeof Status; // "Active" | "Inactive"`,
        ...
        category: 'TypeScript',
        topicId: 'ts-advanced-1',
        tags: ['keyof', 'typeof', 'indexed access', 'lookup types', 'type operators'],
        commonMistakes: [
...
// "/api/v1/users" | "/api/v1/posts" | ... | "/api/v2/comments"`,
        ...
        category: 'TypeScript',
        topicId: 'ts-advanced-1',
        tags: ['template literal types', 'string manipulation', 'Capitalize', 'distributive', 'key remapping'],
        commonMistakes: [
...
// { resource: "users"; id: "123" }`,
        ...
        category: 'TypeScript',
        topicId: 'ts-advanced-1',
        tags: ['infer', 'conditional types', 'type extraction', 'ReturnType', 'recursive types'],
        commonMistakes: [
...
type Merge<A, B> = {
  [K in keyof A | keyof B]: K extends keyof B
    ...
    : never;
        ...
        category: 'TypeScript',
        topicId: 'ts-advanced-1',
        tags: ['custom utility types', 'DeepPartial', 'mapped types', 'conditional types', 'type-level programming'],
        commonMistakes: [
...
if (isUser(data)) {
  console.log(data.name); // safely narrowed to User
        ...
        tags: ['type guards', 'typeof', 'instanceof', 'in', 'type predicates', 'narrowing'],
        commonMistakes: [
...
const strings: string[] = mixed.filter(
  (item): item is string => item !== null
        ...
        category: 'TypeScript',
        topicId: 'ts-type-safety-1',
        tags: ['narrowing', 'control flow', 'satisfies', 'discriminant', 'truthiness'],
        commonMistakes: [
...
type NoArgs<T extends never[]> = T;`,
        ...
        category: 'TypeScript',
        topicId: 'ts-type-safety-1',
        tags: ['never', 'bottom type', 'exhaustive checking', 'unreachable', 'type safety'],
        commonMistakes: [
  ...
  switch (payment.method) {
    ...
    case "crypto":
      return sendCrypto(payment.wallet.address, payment.wallet.network);
        ...
        category: 'TypeScript',
        topicId: 'ts-type-safety-1',
        tags: ['discriminated unions', 'tagged unions', 'exhaustive checking', 'pattern matching', 'state machines'],
        commonMistakes: [
...
console.log(rawConfig.host); // narrowed to Config`,
        ...
        category: 'TypeScript',
        topicId: 'ts-type-safety-1',
        tags: ['assertion functions', 'asserts', 'type predicates', 'narrowing', 'validation'],
        commonMistakes: [
...
console.log(createPositiveInt(5) + 10); // number operations still work`,
        ...
        category: 'TypeScript',
        topicId: 'ts-type-safety-1',
        tags: ['branded types', 'opaque types', 'nominal typing', 'domain modeling', 'type safety'],
        commonMistakes: [
...
function safeParse<T>(
  ...
  try {
    ...
    return null;
        ...
        category: 'TypeScript',
        topicId: 'ts-type-safety-1',
        tags: ['unknown', 'validation', 'API safety', 'error handling', 'type guards', 'Zod'],
        commonMistakes: [
...
// Forces implementation of handlers for LOGIN, LOGOUT, and NAVIGATE`,
        ...
        category: 'TypeScript',
        topicId: 'ts-type-safety-1',
        tags: ['exhaustive checking', 'never', 'Record', 'pattern matching', 'discriminated unions'],
        commonMistakes: [
...
// Each value preserves its literal type`,
        ...
        category: 'TypeScript',
        topicId: 'ts-type-safety-1',
        tags: ['satisfies', 'type safety', 'inference', 'validation', 'literal types'],
        commonMistakes: [
...
/>`,
        ...
        category: 'TypeScript',
        topicId: 'ts-react-1',
        tags: ['React.FC', 'function components', 'props', 'generics', 'children'],
        commonMistakes: [
...
// dispatch({ type: "UNKNOWN" }); // Error: invalid action type`,
        ...
        category: 'TypeScript',
        topicId: 'ts-react-1',
        tags: ['useState', 'useReducer', 'hooks', 'state management', 'discriminated unions'],
        commonMistakes: [
      ...
      },
      {
        id: 'ts-react-3',
        question:
          'How do you type React event handlers in TypeScript?',
        answer:
...
useEffect(() => {
  ...
  return () => window.removeEventListener("resize", handleResize);
        ...
        category: 'TypeScript',
        topicId: 'ts-react-1',
        tags: ['events', 'ChangeEvent', 'MouseEvent', 'FormEvent', 'event handlers'],
        commonMistakes: [
  ...
  return (
    <>
      ...
      <button onClick={() => counterRef.current?.increment()}>+</button>
        ...
        category: 'TypeScript',
        topicId: 'ts-react-1',
        tags: ['useRef', 'forwardRef', 'refs', 'useImperativeHandle', 'DOM refs'],
        commonMistakes: [
      ...
      },
      {
        id: 'ts-react-5',
        question:
          'How do you type React Context with TypeScript?',
        answer:
...
const useI18n = () => useContext(I18nContext); // no null check needed`,
        ...
        category: 'TypeScript',
        topicId: 'ts-react-1',
        tags: ['context', 'useContext', 'createContext', 'providers', 'state management'],
        commonMistakes: [
      ...
      },
      {
        id: 'ts-react-6',
        question:
          'How do you create generic React components in TypeScript?',
        answer:
...
/>`,
        ...
        category: 'TypeScript',
        topicId: 'ts-react-1',
        tags: ['generic components', 'generics', 'reusable components', 'type inference', 'constraints'],
        commonMistakes: [
...
function ModernDashboard({ title }: { title: string }) {
  ...
  return <div>{title} - Welcome, {user?.name}</div>;
        ...
        category: 'TypeScript',
        topicId: 'ts-react-1',
        tags: ['HOC', 'higher-order components', 'ComponentType', 'Omit', 'prop injection'],
        commonMistakes: [
      ...
      },
      {
        id: 'ts-react-8',
        question:
          'How do you type custom hooks in React with TypeScript?',
        answer:
...
useEventListener("keydown", (e) => {
  console.log(e.key); // e is KeyboardEvent
        ...
        category: 'TypeScript',
        topicId: 'ts-react-1',
        tags: ['custom hooks', 'generics', 'discriminated unions', 'useEffect', 'event listeners'],
        commonMistakes: [
...
<Box as="button" onClick={() => {}}>Click</Box> // button props`,
        ...
        category: 'TypeScript',
        topicId: 'ts-react-1',
        tags: ['ComponentProps', 'HTMLAttributes', 'PropsWithChildren', 'polymorphic', 'utility types'],
        commonMistakes: [
