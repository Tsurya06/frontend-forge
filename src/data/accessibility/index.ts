...
export const accessibilityTopics: Topic[] = [
  {
    ...
    description:
      "Comprehensive guide to building accessible web applications including ARIA roles, semantic HTML, keyboard navigation, focus management, screen readers, accessible forms, color contrast, and WCAG compliance.",
  ...
  return (
    <div>
      ...
      {error && <p id={errorId} role="alert">{error}</p>}
        ...
        language: "typescript",
        explanation:
          'Accessible components use proper labeling, ARIA attributes for state, and role="alert" for error announcements.',
      },
    ],
    relatedTopicIds: [],
    questions: [
      {
        id: "a11y-1",
        question:
          "What is semantic HTML and why is it critical for accessibility? Give examples of semantic vs. non-semantic markup.",
  ...
  return (
    <>
      ...
      },
      {
        id: "a11y-2",
        question:
          "What are ARIA roles, states, and properties? When should and shouldn't you use ARIA?",
  ...
  return (
    <div>
      ...
      },
      {
        id: "a11y-3",
        question:
          "How do you implement keyboard navigation in web applications? What are common keyboard interaction patterns?",
...
// .skip-link:focus { position: static; }`,
      ...
      },
      {
        id: "a11y-4",
        question:
          "How do you build accessible forms? Cover labels, error handling, required fields, and form validation.",
  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
      ...
      },
      {
        id: "a11y-5",
        question:
          "What is color contrast and why does it matter? How do you ensure your UI meets WCAG contrast requirements?",
...
Implementing accessible contrast requires integrating it into the design system. Define a color palette with contrast ratios documented for each color combination. Use CSS custom properties (variables) for colors to ensure consistency. Use automated tools (axe-core, Lighthouse) in CI to catch contrast violations. Browser DevTools include contrast checkers in the color picker. Design tools like Figma have contrast-checking plugins. For dark mode, re-verify all contrast ratios — colors that pass in light mode may fail in dark mode and vice versa. Test with real users who have visual impairments when possible.`,
        shortAnswer:
          "Color contrast is the luminance difference between foreground and background. WCAG AA requires 4.5:1 for normal text, 3:1 for large text. Never use color as the only indicator (add icons, text, patterns). Use automated tools (axe-core, Lighthouse) to check. Define contrast-verified color palettes in design systems. Test both light and dark modes.",
  ...
  return (
    <span className={className}>
      ...
      },
      {
        id: "a11y-6",
        question:
          "How do you build an accessible modal dialog? Cover focus management, keyboard interaction, and screen reader announcements.",
  ...
  return (
    <div>
      ...
      },
      {
        id: "a11y-7",
        question:
          "What is WCAG and what are its four principles? How do you achieve compliance?",
...
Integrate accessibility into the development lifecycle rather than treating it as an afterthought. Include axe-core checks in unit tests with jest-axe. Add Lighthouse accessibility audits to CI/CD pipelines. Create accessible component libraries that enforce patterns (every Input requires a label). Train developers on WCAG criteria. Conduct periodic accessibility audits. Document accessibility patterns and requirements in your design system. The goal is to make inaccessible code as unusual as untested code — prevented by tooling, caught in review, and fixed before deployment.`,
        shortAnswer:
          "WCAG provides testable accessibility criteria at three levels (A, AA, AAA). Four principles (POUR): Perceivable (content detectable by senses), Operable (navigable and interactive), Understandable (readable and predictable), Robust (compatible with assistive tech). Achieve compliance with automated testing (axe-core, 30-40% of issues), manual testing (keyboard, screen reader), and integrating a11y into CI/CD.",
...
//   ✓ Name, role, value for custom widgets`,
      ...
      },
      {
        id: "a11y-8",
        question:
          "How do you make interactive components like tabs, menus, and buttons accessible?",
